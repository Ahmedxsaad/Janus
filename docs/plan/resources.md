...
> Legend: [paper] paper · [book] book · [tool] tool/repo · [standard] standard · [security] security · [architecture] architecture.
> [confirm] Deep chapter/page URLs can drift - the landing links below are stable; confirm a specific page before quoting it in the public README.
...
|---|---|---|
| 1 | [paper] Breck 2019, *Data Validation for ML* (TFDV) | The check taxonomy behind P2/P3 detectors. |
| 2 | [paper] Sculley 2015, *Hidden Technical Debt in ML* | Names our villains (undeclared consumers, CACE). |
| 3 | [paper] Sambasivan 2021, *Data Cascades* | Field proof that silent data issues compound. |
| 4 | [tool] mlinspect (SIGMOD 2021) | Lineage-based ML-pipeline inspection = our technique's ancestor. |
| 5 | [tool] Jenga (EDBT 2021) | Corruption injection = our benchmark harness. |
| 6 | [paper] Kaufman 2012, *Leakage in Data Mining* | The target-leakage theory behind P1. |
| 7 | [tool] Anthropic, *Building Effective Agents* | Justifies deterministic-core + gated-LLM + HITL. |
