...
:mod:`~modelguard.agent.pipeline` runs the node order ``detect -> reason ->
...
``modelguard scan`` never needs it.
"""
...
from modelguard.agent.narrate import Narrative, narrate
from modelguard.agent.pipeline import (
    FindingWrites,
    ScanReport,
    TrustWrite,
    _detect,
