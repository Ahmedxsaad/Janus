"""Guard coverage over time, recorded on ModelGuard's own entity (T-15).

:mod:`modelguard.detect.guard_coverage` computes what fraction of a catalog's
...
:mod:`modelguard.writeback.trust_history` appends a score. Same storage decision
...
Where it hangs
--------------
On ModelGuard's own ``dataFlow``, the entity T-04 already creates and hangs every
...
#: :data:`~modelguard.writeback.trust_history.HISTORY_LIMIT` on purpose: the two
