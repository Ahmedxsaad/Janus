...
from janus.writeback.terms import add_term, ensure_term
...
LABEL_TERM_DEFINITION = (
    "The column a model is trained to predict. Janus treats any feature "
...
#: under the names this module has always used. See props/janus_props.yaml
...
def models_with_recorded_link(conn: DataHubConnection) -> tuple[tuple[str, RecordedLink], ...]:
    ...
    Discovery goes through :mod:`janus.discovery` rather than plain search
