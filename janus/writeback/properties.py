"""Define and assign the structured properties Janus owns.
...
The definitions live in ``props/janus_props.yaml`` rather than in code, so a
...
PROPS_FILE = Path(__file__).parent / "props" / "janus_props.yaml"

TRUST_SCORE = "janus.trust_score"
TRUST_BAND = "janus.trust_band"
...
TRUST_HISTORY = "janus.trust_history"
