...
from janus.detect.coverage import MODEL_CHECKS, Unevaluated
...
class NextJoin:
    ...
    the unit of work somebody actually does. One `janus link` on a model
...
class CatalogCoverage:
    ...
    """One row per check in :data:`~janus.detect.coverage.MODEL_CHECKS`
...
def aggregate(sweep: Iterable[ModelCoverage]) -> CatalogCoverage:
    ...
    Returns:
        ...
        :data:`~janus.detect.coverage.MODEL_CHECKS` order, and the single
